...
---
title: "Edited also the second post"
linkTitle: "Second blog post - edited"
date: 2022-08-21
description: >
 In MD, lead description textlines must be indented? Text here can also be **bold** or _italic_ and can even be split over multiple paragraphs.
---

This is the main text.
Note that I edited the date of the blog.
This text was entered on separate lines in md source code, but should appear as a single paragraph. 
